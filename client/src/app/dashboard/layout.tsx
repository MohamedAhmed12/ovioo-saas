...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <main className="flex min-h-screen flex-col dashboard-main-layout pt-32 pb-32 pl-80 pr-8 bg-slate-50 dark:bg-slate-800">            <DashboardHeader openNav={open} onOpenNav={() => setOpen(true)} />
